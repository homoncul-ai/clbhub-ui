# Citizen Dashboard - Use Cases

## Overview

This document outlines all use cases for the Citizen Dashboard, organized in chronological order as a typical student would encounter them during their career planning journey. Assumes the student has completed onboarding and has an assigned guidance counselor.
...
**Main Flow:**
1. Student navigates to `/citizen/home`
...
- Student navigates to `/citizen/statements`
...
2. System navigates to `/citizen/statements/{id}`
...
3. System navigates to `/citizen/search?type=job&statement={statementId}`
...
**Preconditions:**
- Student navigates to `/citizen/search`
...
- Student navigates to `/citizen/interests`
...
**Main Flow:**
1. System navigates to `/citizen/interests/{id}`
...
**Preconditions:**
- Student navigates to `/citizen/guidance`
...
2. System navigates to `/citizen/guidance/tickets/{id}`
...
**Preconditions:**
- Student navigates to `/citizen/messages`
...
**Main Flow:**
1. System navigates to `/citizen/messages/{id}`
...
**Preconditions:**
- Student navigates to `/citizen/progress`
