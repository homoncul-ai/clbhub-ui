# Citizen Dashboard - Functionality Summary

## Overview

The Citizen Dashboard is a **Career & Education Planning Platform** designed for vocational technical citizens. It serves as a centralized hub where students can explore career opportunities, manage their professional development, and connect with guidance counselors and advocates.
...
### 2. Personal Statements (`/citizen/personalstatements`)
...
### 4. Guidance & Support (`/citizen/guidance`)
...
- **Work Request Details** (`/citizen/guidance/workrequests/:ticketId`):
...
### 5. My Communications / Messages (`/citizen/messages`)
...
### 7. Research / Catalog Search (`/citizen/research`)
...
### 8. Resume Entries (`/citizen/resumeentries`)
