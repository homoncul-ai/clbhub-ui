# Student Dashboard - UI/UX Analysis
...
**Location:** `dash-student-interests.component.html` (lines 31-38)
```html
<div *ngIf="true">
...
**Location:** `dash-student-interest.component.ts` (Sign Up/Apply modals)
```html
...
**Location:** `dash-student-progress.component.ts`
- GPA: 3.8 (hardcoded)
...
- `dash-student-home.component.ts` - 180+ line inline template
- `dash-student-messages.component.ts` - external `.html` file
