...
@Component({
  selector: 'app-hccluserprofile-crud',
  templateUrl: './hccluserprofile-crud.component.html',
...
export class HcclUserProfileCrudComponent extends AbstractCrudComponent<HcclUserProfileCrudWrapper> implements OnInit, OnChanges {
/**
