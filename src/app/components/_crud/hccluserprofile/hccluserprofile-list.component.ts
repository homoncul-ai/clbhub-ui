...
@Component({
  selector: 'app-hccluserprofile-list',
  standalone: true,
...
export class HcclUserProfileListComponent extends AbstractListComponent<HcclUserProfileGETData, HcclUserProfileCriteria, HcclUserProfileGETDataSearchResults> {
