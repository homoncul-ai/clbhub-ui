...
@Component({
  selector: 'app-citizen-ui',
  templateUrl: './citizen-ui.component.html',
  standalone: true,
  imports: [
    CommonModule,
    MdbAccordionModule,
...
export class CitizenUiComponent implements OnInit, OnChanges {
  ...
  getMyCitizenTicketsCriteria(): WorkRequestCriteria {
    return {
  ...
  onClickWorkRequestRow(): OnRowClickBehavior {
    ...
    x.getNavigateUrl = (id: string) => {
      ...
      const dashboardBase = segments[0] || 'citizen';
