...
import { WorkQueueTypeRefGETData, WorkQueueTypeRefCriteria, WorkQueueTypeRefGETDataSearchResults } from '../../../restsvc/hccl.service';
import { AbstractListComponent } from '@app/components/_global/abstract-list/abstract-list.component';
import { Observable } from 'rxjs';

/**
 * Component for displaying and managing WorkQueueTypeRef data using HcclService
...
export class WorkQueueTypeRefListComponent extends AbstractListComponent<WorkQueueTypeRefGETData, WorkQueueTypeRefCriteria, WorkQueueTypeRefGETDataSearchResults> {
  ...
  constructor(   
    ...
    this.searchHeading = 'Work Queue Type Refs';
...
//      { id: 'createdByInfo', header: [{ text: 'Created By', align: 'center' }], minWidth: 120, adjust: true },
  ...
  protected createCriteria(): WorkQueueTypeRefCriteria {
    return {
      pageNumber: 1,
      pageSize: 50,
      isPaging: true
  ...
  protected findEntities(criteria: WorkQueueTypeRefCriteria): Observable<WorkQueueTypeRefGETDataSearchResults> {
    return this.hcclService.findWorkQueueTypeRefs(criteria);
  }

  protected hasSearchResults(response: WorkQueueTypeRefGETDataSearchResults): boolean {
    return !!response.searchResults;
  }

  protected getSearchResults(response: WorkQueueTypeRefGETDataSearchResults): WorkQueueTypeRefGETData[] {
    return response.searchResults || [];
  }
