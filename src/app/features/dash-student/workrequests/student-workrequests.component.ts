...
@Component({
  selector: 'app-student-workrequests',
  standalone: true,
  ...
  templateUrl: './student-workrequests.component.html',
  styleUrl: './student-workrequests.component.scss'
})
export class StudentWorkRequestsComponent extends AbstractEntityGroupComponent<HcclUserProfileCrudWrapper> implements OnInit {
