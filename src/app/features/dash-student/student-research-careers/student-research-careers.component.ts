...
@Component({
  selector: 'app-student-research-careers',
  standalone: true,
  imports: [CommonModule, FormsModule, VocationEncodingRefCrudComponent, RouterModule],
  templateUrl: './student-research-careers.component.html',
  styleUrls: ['./student-research-careers.component.scss']
})
export class StudentResearchCareersComponent implements OnInit {
