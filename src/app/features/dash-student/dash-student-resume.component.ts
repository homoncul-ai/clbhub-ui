...
@Component({
  selector: 'app-dash-student-resume',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './dash-student-resume.component.html',
  styleUrls: ['./dash-student-resume.component.scss']
})
export class DashStudentResumeComponent implements OnInit {
