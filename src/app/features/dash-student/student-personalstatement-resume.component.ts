...
@Component({
  ...
  templateUrl: './student-personalstatement-resume.component.html',
  styleUrls: ['./student-personalstatement-resume.component.scss']
})
export class StudentPersonalStatementResumeComponent implements OnInit {
