...
@Component({
  selector: 'app-citizen-resumeentry-details',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './citizen-resumeentry-details.component.html',
  styleUrls: ['./citizen-resumeentry-details.component.scss']
})
export class CitizenResumeEntryDetailsComponent implements OnInit {
