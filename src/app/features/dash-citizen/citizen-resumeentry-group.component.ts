...
import { CitizenResumeEntriesListComponent } from './citizen-resumeentries-list.component';
import { CitizenResumeEntryDetailsComponent } from './citizen-resumeentry-details.component';
import { OnRowClickBehavior } from '@app/components/_global/abstract-list/abstract-list.component';
import { MdbModalService } from 'mdb-angular-ui-kit/modal';
import { CreateResumeEntryModalComponent } from './create-resume-entry-modal.component';

@Component({
  selector: 'app-citizen-resumeentry-group',
  standalone: true,
  imports: [
    CommonModule,
    SimpleTabsetComponent,
    CitizenResumeEntriesListComponent,
    CitizenResumeEntryDetailsComponent
  ],
  styleUrl: '../../components/_global/abstract-entity-group/abstract-entity-group.component.scss',
  templateUrl: './citizen-resumeentry-group.component.html',
})
export class CitizenResumeEntryGroupComponent implements OnInit {
  ...
  protected calculateTabIdFromUrl(): string {
    ...
    // URL structure: /citizen/resumeentries or /citizen/resumeentries/:id/:tabId
