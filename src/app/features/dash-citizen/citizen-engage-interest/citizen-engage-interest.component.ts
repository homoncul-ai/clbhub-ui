...
@Component({
  selector: 'app-citizen-engage-interest',
  standalone: true,
  imports: [
  ...
  templateUrl: './citizen-engage-interest.component.html',
  styleUrl: './citizen-engage-interest.component.scss'
})
export class CitizenEngageInterestComponent 
