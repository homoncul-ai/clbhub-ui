...
@Component({
  selector: 'app-citizen-personalstatement-search',
  standalone: true,
  imports: [CommonModule, FormsModule, StdBubaComponent],
  templateUrl: './citizen-personalstatement-search.component.html',
  styleUrls: ['./citizen-personalstatement-search.component.scss']
})
export class CitizenPersonalStatementSearchComponent extends AbstractMultimodeComponent<PersonalStatementCrudWrapper> implements OnInit  {
