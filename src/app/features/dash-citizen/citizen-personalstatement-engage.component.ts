...
import { CitizenEngageInterestComponent } from './citizen-engage-interest/citizen-engage-interest.component';

@Component({
  selector: 'app-citizen-personalstatement-engage',
  standalone: true,
  imports: [CommonModule, CatalogEntryInterestListComponent, CitizenEngageInterestComponent],
  templateUrl: './citizen-personalstatement-engage.component.html',
  styleUrl: '../../components/_global/abstract-crud/abstract-crud.component.scss'
})
export class CitizenPersonalStatementEngageComponent 
extends AbstractMultimodeComponent<PersonalStatementCrudWrapper> implements OnInit  {
  ...
  override async ngOnInit(): Promise<void> {
    super.ngOnInit();
    console.log('CitizenPersonalStatementEngageComponent ngOnInit');
  ...
  protected override async prepareModeEntry(entity: PersonalStatementCrudWrapper, mode: string): Promise<void> {
    ...
    console.log('CitizenPersonalStatementEngageComponent prepareModeEntry ' + this.entity.dump);
  ...
  // Methods for interest selection behavior (same as citizen-engage.component.ts)
