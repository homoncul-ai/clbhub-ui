...
@Component({
  selector: 'app-dash-citizen-messages',
  standalone: true,
  imports: [CommonModule, MdbAccordionModule, PMessageListComponent, PMessageUiComponent, HcclUserInviteListComponent],
  styleUrl: './dash-citizen-messages.component.scss',
  templateUrl: './dash-citizen-messages.component.html',
})
export class DashCitizenMessagesComponent extends AbstractEntityGroupComponent<HcclUserProfileCrudWrapper> implements OnInit, OnDestroy, OnChanges {  
  ...
  //  x.alertMessage = 'Message';
    ...
    x.getNavigateUrl = (id: string) => {
      ...
      return ['citizen', 'messages', id, 'message'];
    };
    return x;
  }
