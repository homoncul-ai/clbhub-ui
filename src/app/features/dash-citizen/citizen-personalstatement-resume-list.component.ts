 ...
 */
@Component({
  selector: 'app-citizen-personalstatement-resume-list',
  standalone: true,
...
export class CitizenPersonalStatementResumeListComponent extends AbstractListComponent<PersonalStatementResumeGETData, PersonalStatementResumeCriteria, PersonalStatementResumeGETDataSearchResults> implements OnInit {
