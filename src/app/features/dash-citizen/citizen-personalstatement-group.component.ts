...
import { CitizenPersonalStatementSearchComponent } from './citizen-personalstatement-search.component';
import { CitizenPersonalStatementEngageComponent } from './citizen-personalstatement-engage.component';
...
import { CitizenPersonalStatementResumeComponent } from './citizen-personalstatement-resume.component';
...
@Component({
  selector: 'app-citizen-personalstatement-group',
  standalone: true,
  imports: [CommonModule, SimpleTabsetComponent,
    CitizenPersonalStatementSearchComponent, CitizenPersonalStatementEngageComponent, 
    CitizenPersonalStatementResumeListComponent, CitizenPersonalStatementResumeComponent, 
    CitizenPersonalStatementDetailsComponent, MapAddrUiComponent],
  styleUrl: '../../components/_global/abstract-entity-group/abstract-entity-group.component.scss',
  templateUrl: 'citizen-personalstatement-group.component.html',
})
export class CitizenPersonalStatementGroupComponent extends AbstractEntityGroupComponent<PersonalStatementCrudWrapper> implements OnInit {  
