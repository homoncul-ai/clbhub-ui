...
@Component({
  selector: 'app-dash-citizen-my-participation',
  standalone: true,
  imports: [CommonModule, MdbAccordionModule, CatalogEntryInterestListComponent, CitizenEngageInterestComponent],
  template: `
...
export class DashCitizenMyParticipationComponent implements OnInit {
