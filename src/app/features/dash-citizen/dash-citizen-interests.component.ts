...
@Component({
  selector: 'app-dash-citizen-interests',
  standalone: true,
  ...
  templateUrl: './dash-citizen-interests.component.html',
})
export class DashCitizenInterestsComponent 
extends AbstractEntityGroupComponent<HcclUserProfileCrudWrapper> implements OnInit {  
  ...
  protected setupTabs(): SimpleTab[] {
    ...
    var tabs: SimpleTab[] = [
      ...
      this.interestTab = new SimpleTab('interest', "Interest", '', 
        () => {
          this.router.navigate(['citizen', 'interests', this.interestId, 'interest']);
        },
        () => {
  ...
  //  x.alertMessage = 'Message';
    ...
    x.getNavigateUrl = (id: string) => {
      ...
      return ['citizen', 'interests', id, 'interest'];
    };
    return x;
  }
