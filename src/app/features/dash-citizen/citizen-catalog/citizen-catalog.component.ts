...
@Component({
  selector: 'app-citizen-catalog',
  standalone: true,
  imports: [CommonModule, FormsModule, CatalogEntryCrudComponent, RouterModule, PersonalStatementSelectorComponent],
  templateUrl: './citizen-catalog.component.html',
  styleUrls: ['./citizen-catalog.component.scss']
})
export class CitizenCatalogComponent implements OnInit {
