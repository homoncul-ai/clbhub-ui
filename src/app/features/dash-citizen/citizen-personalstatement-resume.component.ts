...
@Component({
  selector: 'app-citizen-personalstatement-resume',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './citizen-personalstatement-resume.component.html',
  styleUrls: ['./citizen-personalstatement-resume.component.scss']
})
export class CitizenPersonalStatementResumeComponent implements OnInit {
