...
@Component({
  selector: 'app-citizen-workrequests',
  standalone: true,
  imports: [CommonModule, SimpleTabsetComponent, 
    ...
    WorkRequestItemAttachRFIContentAddEntriesComponent, WorkRequestLogListComponent],
  templateUrl: './citizen-workrequests.component.html',
  styleUrl: './citizen-workrequests.component.scss'
})
export class CitizenWorkRequestsComponent extends AbstractEntityGroupComponent<HcclUserProfileCrudWrapper> implements OnInit {
  ...
  protected setupTabs(): SimpleTab[] {
    ...
    var tabs: SimpleTab[] = [
      ...
      if (this.ticketId != null && this.ticketId != '') {
        tabs.push(new SimpleTab('ticket', '' + this.getTicket()?.businessCode, '', 
          () => {
            var path =   ['/citizen/guidance', 'workrequests', this.ticketId, 'ticket'];
    ...
    var tab: SimpleTab =  new SimpleTab('logs', 'Logs X', '', 
      () => {
         var path =   ['/citizen/guidance', 'workrequests', this.ticketId, 'logs'];
         this.router.navigate(path);
    ...
    tabs.push(tab)
     ...
     tab =  new SimpleTab('items', 'Items', '', 
      () => {
        ...
        var path =   ['/citizen/guidance', 'workrequests', this.ticketId, 'items'];
        this.router.navigate(path);
    ...
    tab =  new SimpleTab('workRequestItem', 'Item', '', 
      () => {
        var path =   ['/citizen/guidance', 'workrequests',  this.ticketId, 'workRequestItem', this.workRequestItemId];
        this.router.navigate(path);
        //this.currentTabId = 'workRequestItem';
  ...
  onClickWorkRequestRow(): OnRowClickBehavior {
    ...
    x.getNavigateUrl = (id: string) => {
      return ['/citizen/guidance', 'workrequests', id];
    };
  ...
  protected myOnWorkRequestItemRowClickBehavior(): OnRowClickBehavior {
    ...
    x.getNavigateUrl = (id: string) => {
      ...
      var path = ['/citizen/guidance', 'workrequests', this.ticketId, 'workRequestItem', id];
