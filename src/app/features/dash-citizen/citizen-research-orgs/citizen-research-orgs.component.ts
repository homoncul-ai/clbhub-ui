...
@Component({
  selector: 'app-citizen-research-orgs',
  standalone: true,
  imports: [CommonModule, FormsModule, StdMarkdownDisplayComponent],
  templateUrl: './citizen-research-orgs.component.html',
  styleUrls: ['./citizen-research-orgs.component.scss']
})
export class CitizenResearchOrgsComponent implements OnInit {
