 ...
 */
@Component({
  selector: 'app-citizen-resumeentries-list',
  standalone: true,
...
export class CitizenResumeEntriesListComponent extends AbstractListComponent<ResumeEntryGETData, ResumeEntryCriteria, ResumeEntryGETDataSearchResults> {
