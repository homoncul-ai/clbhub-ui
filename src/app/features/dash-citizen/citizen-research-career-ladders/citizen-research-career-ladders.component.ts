...
@Component({
  selector: 'app-citizen-research-career-ladders',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './citizen-research-career-ladders.component.html',
  styleUrls: ['./citizen-research-career-ladders.component.scss'],
})
export class CitizenResearchCareerLaddersComponent implements OnInit {
