...
@Component({
  selector: 'app-swcat-trutesta-tab-usageorg',
  templateUrl: './dash-swcat-trutesta-tab-usageorg.component.html',
  imports: [CommonModule],
  standalone: true
})
export class DashSwcatTrutestaTabUsageorgComponent extends AbstractMultimodeComponent<HcclUserProfileCrudWrapper> implements OnInit, AfterViewInit {
  ...
  constructor() {
    super();
    console.log('DashSwcatTrutestaTabUsageorgComponent');
  }
...
// Generate quarters
  ...
  private createChart(): void {
    ...
    ctx.fillStyle = '#333';
    ctx.fillText('Quarterly User Growth Trends - Organization View', width / 2, 30);
