...
@Component({
  selector: 'app-swcat-sematree-group-component',
  standalone: true,
  imports: [CommonModule, SimpleTabsetComponent,
     DashSwcatSematreeTabOverviewComponent, DashSwcatSematreeTabUsageComponent],
  styleUrl: '../../components/_global/abstract-entity-group/abstract-entity-group.component.scss',
  templateUrl: './dash-swcat-sematree-group.component.html',
})
export class DashSwcatSematreeGroupComponent extends AbstractEntityGroupComponent<HcclUserProfileCrudWrapper> implements OnInit {  
  ...
  //  x.alertMessage = 'Message';
    ...
    x.getNavigateUrl = (id: string) => {
      ...
      return ['swcat-dashboard', 'sematree', id, 'message'];
    };
    return x;
  }
