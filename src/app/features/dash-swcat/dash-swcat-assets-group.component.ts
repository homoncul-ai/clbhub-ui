...
@Component({
  selector: 'app-swcat-assets-group-component',
  standalone: true,
  imports: [CommonModule, SimpleTabsetComponent,
     DashSwcatAssetsTabOverviewComponent, DashSwcatAssetsTabGraphsComponent, DashSwcatAssetsTabContractsComponent],
  styleUrl: '../../components/_global/abstract-entity-group/abstract-entity-group.component.scss',
  templateUrl: './dash-swcat-assets-group.component.html',
})
export class DashSwcatAssetsGroupComponent extends AbstractEntityGroupComponent<HcclUserProfileCrudWrapper> implements OnInit {  
  ...
  protected setupTabs(): SimpleTab[] {
    ...
    var tabs: SimpleTab[] = [
      ...
      new SimpleTab('graphs', 'Graphs', '', 
        () => {
          this.router.navigate([baseRoute, 'graphs']);
        },
        () => {
          return true;
        }
      ),
      new SimpleTab('contracts', 'Contracts', '', 
        () => {
          this.router.navigate([baseRoute, 'contracts']);
        },
        () => {
          return true;
        }
  ...
  //  x.alertMessage = 'Message';
    ...
    x.getNavigateUrl = (id: string) => {
      ...
      return ['swcat-dashboard', 'assets', id, 'message'];
    };
    return x;
  }
