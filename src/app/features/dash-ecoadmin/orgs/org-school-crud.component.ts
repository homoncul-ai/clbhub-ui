...
@Component({
  ...
  templateUrl: './org-school-crud.component.html',
...
export class OrgSchoolCrudComponent extends AbstractCrudComponent<HcclOrganizationCrudWrapper> implements OnInit, OnChanges {
  ...
  // protected override switchToDetailMode(): void {
  //   alert("switchToDetailMode" + JSON.stringify(this.getCurrentEntity()?.getData()));
  //   super.routeToPath(['/ecoadmin-dashboard/orgs/schools']);
  // }
  protected override switchToEditMode(): void {
    //alert("switchToEditMode" + JSON.stringify(this.getCurrentEntity()?.getData()));
